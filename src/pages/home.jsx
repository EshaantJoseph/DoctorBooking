            ...
            {/* ----------------hero content----------- */}
               ...
               <div>
                <div className="lg:w-[570px]">
                    ...
                    {/* ------------hero counter--------- */}
                     <div className="mt-[30px] lg:mt-[70px] flex flex-row lg:items-center
                     gap-5 lg:gap-[30px]">
                     
                     <div>
                     <h2 className="text-[36px] leading-[56px] lg:tex-[44px] lg:leading-[54px]
                        ...
                        <div className="mt-[30px]">
                            <h2 className="text-[26px] leading-9 text-headingColor font-[700] text-center">
                                ...
                                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                                    We offer world-class care for everyone. From the lab to the clinic.
                                </p>
                                <Link to='/doctors' className="w-[44px] rounded-full border border-solid border-[#181A1E]
                                mt-[30px] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor 
                                hover:border-none">
                        ...
                        <h2 className="heading">
                            ...
                            <ul className="pl-4">
                                <li className="text__para">
                                    1. Schedule my appointement directly.
                                </li>
                                <li className="text__para">
                                    2. Search of your physician here, and contact their office.
                                </li>
                                <li className="text__para">
                        ...
                        <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md: bottom
                           ...
                           text-[8px] leading-[8px] lg:text-[12px] lg: leading-4 text-irisBlueColor font-[500] mt-2 lg:mt-4 rounded-full">
                            ...
                            <div className="flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]">
                                ...
                                <h4 className="text-[10px] leading-3 lg:text-[16px] lg:leading-[22px] font-[780]
                                     text-headingColor">
                                     Wayne Collins
                                     </h4>
                            </div>
